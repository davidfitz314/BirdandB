...
<a href="chapter7.php"><strong>Chapter 7:</strong></a>
</div>
<ul>
<li>
<a href="#defining_love">Defining Love</a>
</li>
<li>
<a href="#female_body_reactions">Female Body Reactions</a>
</li>
<li>
<a href="#male_body_reactions">Male Body Reactions</a>
</li>
<li>
<a href="#male_and_female_similar_sex_responses">Male and Female Similar Sex Responses</a>
</li>
<li>
<a href="#psychological_impacts_of_sex">Psychological Impacts of Sex</a>
</li>
</ul>
...
People can love:</p>
	...
	<ul class="closedCircle">
		...
		<li>Kissing another person’s cheek, can be sensual and or sexual way to express love.</li>
	...
	<ul class="closedCircle">
		<li>Brain activities change when they are in love.</li>

		<li>Heart rate slows down.</li>

		<li>Affects hormone levels.</li>

		<li>Many will have trouble sleeping because they think too much about the one they love.</li>

		<li>Bodies have less aches and pains, love activates the same neural receptors in the brain as pain-soothing drugs, according to a study from Stanford University School of Medicine.</li>

		<li>Can become forgetful, brain releases oxytocin (often thought of as the love hormone), which can impair memory.</li>
	...
	<ul class="closedCircle">
		...
		<li>Bodies synchronize with their target.</li>

		<li>More sweat may be produced then normal.</li>

		<li>Experience a dopamine high.</li>

		<li>Serotonin levels may lower.</li>
	</ul>

	<div class="ch7ImagesB">
		<img src="includes/images/chapter7/eyes.png" alt="Pair of eyes">
	</div>

	<h4>During &amp; After Sex Reactions</h4>
	<ul>
		<li>Air can be released from lady parts.</li>

		<li>More fluids are produced.</li>

		<li>During sexual arousal, the body becomes its own chemistry lab. But it isn’t until orgasm is achieved that the chemicals that promote stress relief, relaxation, and sleep are released.</li>

		<li>Loss of energy.</li>

		<li>Females can get urinary tract infections after sex.</li>
<!- Interesting Fact goes here ->

		<li>Some women will feel pain during sex regardless of how many times they have done it in the past.</li>

		<li>Some women will notice they have firmer or bigger breasts for a time, increased nipple sensitivity, retain water or otherwise feel bloated, and occasionally have flushed and red skin or bright, shining eyes.</li>

		<li>In some cases, a female’s body will respond in such a way that her period is late, leading to fears about pregnancy.</li>
		
	<li>Many females feel uncomfortable for a while after sex, especially if it was their first time, or if they had rougher sex than usual. For first timers, the breaking of the hymen will causes bleeding in sex – that is if the hymen was still intact – and can lead to pain and soreness for several days afterward. There is also the soreness of unaccustomed activity, and muscles responding to the new exercise.</li>
	</ul>

	<div class="ch7Images">
		<img src="includes/images/chapter7/femaleBody.png" alt="2 females posing and sitting">
	</div>
	...
	<ul class="closedCircle">
	<li>Cheeks flush, palms sweat, and heart races.</li>

	<li>Pupils dilate.</li>

	<li>May feel a little sick.</li>

	<li>The combination of love and fear can give you sudden superhuman strength in an emergency.</li>

	<li>Trouble focusing on anything but your partner.</li>
	</ul>
	...
	<li>In the Orgasm phase: Contractions occur in the penis, seminal fluid collects in the urethral bulb–this is when a man may have the sensation that orgasm is certain, or "ejaculatory inevitability"–then semen is ejaculated from the penis.</li>

	<li>In the After phase: The penis returns to its normal flaccid state and there is usually a refractory period–where it's impossible to orgasm again until a certain amount of time has passed. The amount of time for the refractory period varies among men by age, physical fitness, and other factors.</li>
	</ul>

	<div class="ch7Images">
		<img src="includes/images/chapter7/maleBody.png" alt="2 male figures posing">
	</div>
	...
	<li>Harder breathing, pulse rates and blood pressure rise, muscle tension and blood-vessel engorgements reach a peak, and sometimes orgasm comes with a grasping-type muscular reflex of the hands and feet.</li>
	<li>After sex, swelling recedes, any sex flush disappears, and there is a general relaxation of muscle tension.</li>
	</ul>
	...
	<ul class="closedCircle">
	<li>Jealousy can become quite common for both partners after sexual or love interactions.</li>
	<li>It is common to feel all kinds of emotional upheaval after sex. In addition to the body changes after sex, the mental and emotional changes can take a physical toll.</li>
	<li>For first time sex experience, some feel anything from euphoria, to guilt, to worry, and everything else in between, regardless of how long they have been with their partner.</li>
	<li>Based on how you were raised or  what morals you hold, having casual sex can be either detrimental or helpful to your psychological health.</li>
