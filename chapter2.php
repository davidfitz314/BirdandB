...
<!- note check images sizes from here on ->
	...
	<!- image and week# ->
	<div class="plant_circle">
	<img src="includes/images/chapter2/lime.png" alt="lime" style="width:65px;height:79px">	
	</div>
	...
	<!- image and week# ->
	<div class="plant_circle">
	<img src="includes/images/chapter2/scallion.png" alt="scallion" style="width:22px;height:65px">	
	</div>
