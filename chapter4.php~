...
<h2>Chapter 4: Human Nature and Psychological Dependencies </h2>
...
<li>
<a href="#child_behavior_and_attachments">Child Behavior and Attachments</a>
</li>
<li>
<a href="#adult_behavior_and_attachments">Adult Behavior and Attachments</a>
</li>
</ul>
...
<img src="includes/images/chapter4/faces(bounce).png" alt="Multiple Emoticons and Types">
</div>
...
<div class="ch1num1">
	<div class="tooltip">
  		<span class="tooltiptext"><strong>Interesting Fact:</strong> Boredom has a bright side. Bored people are often looking for ways to do good things as the entertainment bores them and does not bring meaning to their lives.</span>
	</div>
</div>
<!- end interesting fact section ->
...
<!- end interesting fact section ->
		...
		<li><span class="vocabColor">Anticipation:</span> combines with Joy to create Optimism or combines with Anger to create Aggressiveness.</li>

		<li><span class="vocabColor">Joy:</span> combines with Acceptance to create Love or combines with Anticipation to create Optimism.</li>

		<li><span class="vocabColor">Acceptance:</span> combines with Fear to create Submission or combines with Joy to create Love.</li>

		<li><span class="vocabColor">Fear:</span> combines with Surprise to create Awe or combines with Acceptance to create Submission.</li>

		<li><span class="vocabColor">Surprise:</span> combines with Sadness to create Disappointment or combines with Fear to create Awe.</li>

		<li><span class="vocabColor">Sadness:</span> combines with Disgust to create Remorse or combines with Surprise to create Disappointment.</li>
	</ul>		

<!- interesting fact goes here ->
<div class="ch1num1">
	<div class="tooltip">
  		<span class="tooltiptext"><strong>Interesting Fact:</strong> In 1990 Ortony and Turner published a table for Robert Plutchik’s emotion model and added in an inclusion section discussing relationships of emotional groups and where they are seen in Human Nature.</span>
	</div>
</div>
<!- end interesting fact section ->
	...
	<ul class="solidCircle">
		...
		<li><span class="vocabColor">Secure from Child:</span> The child is Distressed when caregiver leaves, happy when caregiver returns, and seeks comfort from the caregiver when scared or sad.</li>	

<!- interesting fact goes here ->
<div class="ch1num1">
	<div class="tooltip">
  		<span class="tooltiptext"><strong>Interesting Fact:</strong> When people are being watched, they behave better. And the illusion of being watched works, too. It was enough to hang a picture of human eyes in a self-service cafeteria, so that more people began to collect their dishes.</span>
	</div>
</div>
<!- end interesting fact section ->

		<li><span class="vocabColor">Avoidant from Caregiver:</span> The caregiver is unresponsive, uncaring or dismissive towards the child.</li>

		<li><span class="vocabColor">Avoidant from Child:</span> The child does not acknowledge the caregiver arriving or leaving and does not seek or make contact with caregiver.</li>

		<li><span class="vocabColor">Ambivalent from Caregiver:</span> The caregiver responds inconsistently to the child.</li>

		<li><span class="vocabColor">Ambivalent from Child:</span> The child is distressed when the caregiver leaves but feels no comfort by the return of the caregiver.</li>

		<li><span class="vocabColor">Disorganized from Caregiver:</span> The caregiver is abusive or neglectful and often responds in frightening or frightened ways towards the child.</li>

		<li><span class="vocabColor">Disorganized from Child:</span> The child has no attaching behaviors, often appears dazed, confused, or apprehensive in presence of caregiver.</li>
	</ul>	
	...
	<ul class="solidCircle">
		...
		<li><span class="vocabColor">Dismissing adults</span> cannot recall parental interactions or minimize impact of parents on their development.</li>

		<li><span class="vocabColor">Resistant/Preoccupied adults</span> are intensely focused on their parents, they tend to give confused and angry accounts or attachment experiences.</li>
...
<div class="ch1num1">
	<div class="tooltip">
  		<span class="tooltiptext"><strong>Interesting Fact:</strong> People tend to commit immoral acts or do not fulfill someone’s request for help, if no effort is needed and they do not have to refuse a person directly.</span>
	</div>
</div>
<!- end interesting fact section ->
