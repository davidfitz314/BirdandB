...
<img src="includes/images/chapter5/kiss.png" alt="Two lips kissing">
</div>
...
<br>
	...
	<p>Sex is also a term used to describe the action of reproduction in species regardless of gender, but the technical word for sex actions is Sexual Intercourse. The most common type of sexual intercourse is hetero-sexual Intercourse, also known as the act of penetration of the vagina by a penis. </p>
	...
	<p><strong class="addItallic">Sexual activity</strong> is slightly different than sex because it can be classified into sexual orientations, relationships, and genders of the participants. A quick look at how they categorize sexual activity is listed below:</p>
	<ul class="solidCircle">
	...
	<p><strong class="addItallic">Sexual Behavior</strong></p>
	...
	<p><strong class="addItallic">Age & Sexual Activity</strong></p>
	<ul class="solidCitcle">
		<li>The first intercourse for males average was 16.8yrs old and for females it was 17.2yrs old.</li>

		<li>28% of Americans over age 45 report they had sexual intercourse once a week or more in the last six months, and 40% report having intercourse at least once a month.</li>

		<li>More than one in five Americans over age 45 (22%) say they engage in self-stimulation at least once a week.</li>
	...
	<p><strong class="addItallic">Condom Use</strong></p>
	<ul class="solidCitcle">
	...
	<p><strong class="addItallic">Masturbation</strong></p>
	<ul class="solidCitcle">
	...
	<p><strong class="addItallic">Orgasm</strong></p>
	<ul class="solidCitcle">
		...
		<li>Men are more likely to orgasm when sex includes vaginal intercourse; women are more likely to orgasm when they engage in a variety of sex acts and when oral sex or vaginal intercourse is included.</li>

		<li>Women are much more likely to be nearly always or always orgasmic when alone than with a partner. However, among women currently in a partnered relationship, 62% say they are very satisfied with the frequency/consistency of orgasm.</li>
	...
	<p><strong class="addItallic">Sexual Orientation</strong></p>
	<ul class="solidCitcle">
		<li>An estimated 3.5% of adults in the United States identify as lesbian, gay, or bisexual.</li>

		<li>.5-1% of the United States population is estimated to be asexual (no attraction to anyone)</li>
	...
	<p><strong class="addItallic">Pornography</strong></p>
	<ul class="solidCitcle">
